...
def upload_file():
    ...
    unique_link = generate_unique_link()  # 生成一个唯一链接
    download_links = []
    ...
    try:
        ...
        # 返回第一个链接，因为所有文件共用一个链接
        return jsonify(success=True, download_link=download_links[0])
...
if __name__ == '__main__':
    logging.info('服务器启动中...')
    # 当前版本 20241029
    logging.info("当前版本v20241029,  ----By Jerry")
